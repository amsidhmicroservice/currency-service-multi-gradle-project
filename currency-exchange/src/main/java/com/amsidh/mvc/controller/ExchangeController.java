...
import com.amsidh.mvc.entity.Exchange;
...
public class ExchangeController {
    ...
    public Exchange getCurrencyExchange(@PathVariable("currencyFrom") String currencyFrom, @PathVariable("currencyTo") String currencyTo) {
        ...
        CompletableFuture.runAsync(() -> myService.processMyRequest("Amsidh Babasha Lokhande"), currentTraceContext.executor(Runnable::run));
